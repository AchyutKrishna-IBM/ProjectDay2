	   ...
	   @AfterMethod
	    public void productDeletion()
	    {
		   ...
		   String searchEle=p.getProperty("search");
	    	...
	    	adm.clickOnCatalog();
	    	adm.clickOnProducts();
	    	adm.searchElementToBeDeleted(searchEle);
	    	adm.clickOnProductActionEle();
	    	adm.selectDeleteEle();
	    	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='sa-confirm-button-container']/button")));
	    	adm.clickOnconfDelEle();
	    	adm.imageDeletionConf();
